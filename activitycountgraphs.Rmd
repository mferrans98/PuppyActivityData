...
```{r}
#Leo, 8 weeks
ggplot(subset(indiv_weekly_dev,weeksold=="16" & name=="Stanley"), aes(x=intervaltime, y=meandeviance, group=1)) + ylim(-500,2500) + geom_line() + ggtitle("Stanley: 16 weeks") + xlab("Time") + ylab("Activity Counts (mean deviance)") + labs(colour = "Age (weeks)") +
